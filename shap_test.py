...
layer_names = ['block1_conv1','block1_conv2','block2_conv2','block3_conv1',
...
for layer_name in layer_names:
    ...
    e = shap.GradientExplainer((model.layers[index].input, model.layers[-1].output), map2layer(preprocess_input(X.copy()), index))
    ...
    plt.savefig('./shap/'+layer_name+'.jpg')
